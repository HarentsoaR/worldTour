...
export default function MainLand() {
  return (
    <InitialLoadingWrapper>
      <div className="flex flex-col w-full bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        <HeroVideo />
        ...
        <motion.section
          className="w-full bg-blue-50 dark:bg-blue-900 py-12 sm:py-16 lg:py-20"
          initial="hidden"
          whileInView="visible"
          variants={sectionVariants}
